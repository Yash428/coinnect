...
import { loginUser, registerUser, logoutUser, updateUserAvatar, resetPassword, getLoggedInUser} from "../controllers/user.controller.js";
...
router.route("/getCurrentUser").get(verifyJWT, getLoggedInUser)
